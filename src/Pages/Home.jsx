            ...
            <section className="relative min-h-[100vh] py-8 text-center bg-gradient-to-r from-slate-100 via-gray-200 to-slate-300 dark:bg-gradient-to-r dark:from-black dark:via-gray-800 dark:to-black flex flex-col justify-center items-center overflow-hidden">
                ...
                <div className="relative z-10 max-w-4xl mx-auto px-6">
                    ...
                    <div className="mt-16 animate-bounce">
                        <a href="#about" className="text-2xl cursor-pointer opacity-70">⬇</a>
                    </div>
                </div>
            </section>

            {/* About Section */}
            <section id="about" className="min-h-[101vh] py-7 px-2 sm:px-3 md:px-4 lg:px-6 bg-gradient-to-b from-gray-100 to-base-200 dark:from-gray-900 dark:to-black flex flex-col justify-evenly">
                ...
                <div className="max-w-6xl mx-auto mt-7 grid md:grid-cols-2 gap-12 items-center">
                    {/* Image */}
                    <div className="flex justify-center relative group animate-pulses">
